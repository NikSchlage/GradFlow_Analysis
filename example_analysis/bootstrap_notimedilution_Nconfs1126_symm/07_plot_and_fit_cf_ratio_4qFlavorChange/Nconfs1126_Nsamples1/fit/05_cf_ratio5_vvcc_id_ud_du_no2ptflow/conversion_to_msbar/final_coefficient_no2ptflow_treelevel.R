...
tikzDevice::tikz( file = "AIC_fit_results_cf_ratio_5_vvcc_id_ud_du_Nconfs1126_Nsamples1_msbar_no2ptflow_treelevel.tex", standAlone = TRUE, width = 4.5, height = 3,
...
tools::texi2dvi( "AIC_fit_results_cf_ratio_5_vvcc_id_ud_du_Nconfs1126_Nsamples1_msbar_no2ptflow_treelevel.tex", pdf=TRUE )