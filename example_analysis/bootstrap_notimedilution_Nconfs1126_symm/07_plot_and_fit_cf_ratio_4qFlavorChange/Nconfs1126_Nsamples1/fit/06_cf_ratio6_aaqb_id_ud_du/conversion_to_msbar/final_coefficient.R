...
tikzDevice::tikz( file = "AIC_fit_results_cf_ratio_6_aaqb_id_Nconfs1126_Nsamples1_msbar.tex", standAlone = TRUE, width = 4.5, height = 3,
...
tools::texi2dvi( "AIC_fit_results_cf_ratio_6_aaqb_id_Nconfs1126_Nsamples1_msbar.tex", pdf=TRUE )