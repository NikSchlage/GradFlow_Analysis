...
for ( i in 1:length(my_gft) ) {
  ...
  AIC_fit( Rdata=ratio_2_g5[[i]],
           gradflow_t=my_gft[i],
           filename=paste0("fit_cf_ratio_2_vvcc_g5_gft", my_gft[i], "_Nsamples1"),
           x_lab="$\\langle O_{vv}^{cc}\\, O_{\\gamma_5}\\rangle (t_\\mathrm{gf}) / \\langle O_{\\gamma_5}\\, O_{\\gamma_5} \\rangle (t_\\mathrm{gf})$",
