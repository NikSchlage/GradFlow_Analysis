...
for ( i in 1:length(my_gft) ) {
  ...
  AIC_fit( Rdata=ratio_3_g5_no2ptflow[[i]],
           gradflow_t=my_gft[i],
           filename=paste0("fit_cf_ratio_3_aaqb_g5_gft", my_gft[i], "_Nsamples1_no2ptflow"),
           x_lab="$\\langle O_{aa}^{qb}\\, O_{\\gamma_5}\\rangle (t_\\mathrm{gf}) / \\langle O_{\\gamma_5}\\, O_{\\gamma_5} \\rangle (0)$",
