...
res <- read.table("./AIC_fit_results_cf_ratio_2_vvcc_g5_no2ptflow.txt")

print(res[,2])
print(res[,1])


tikzDevice::tikz( file = "AIC_fit_results_cf_ratio_2_vvcc_g5_Nconfs350_Nsamples1_no2ptflow.tex", standAlone = TRUE, width = 4.5, height = 3)
...
tools::texi2dvi( "AIC_fit_results_cf_ratio_2_vvcc_g5_Nconfs350_Nsamples1_no2ptflow.tex", pdf=TRUE )