...
for ( i in 1:length(my_gft) ) {
  ...
  AIC_fit( Rdata=ratio_6_id_no2ptflow[[i]],
           gradflow_t=my_gft[i],
           filename=paste0("fit_cf_ratio_6_aaqb_id_gft", my_gft[i], "_Nsamples1_no2ptflow"),
           x_lab="$\\langle O_{aa}^{qb}\\, O_{1}\\rangle (t_\\mathrm{gf}) / \\langle O_{1}\\, O_{1} \\rangle (0)$",
